...
import iot.models.manager.EntityManager;

import iot.controller.implementation.AbstractControllerImpl;
...
public class MyViewOperations<E, I> {
    ...
    public MyViewOperations(AbstractControllerImpl<E, I> controller, Class<E> eClass) {
